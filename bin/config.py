...
@dataclass                              # <- decorator, not a base class
class Settings:
    ...
    default_basis_topical: str = "w/w"
    default_basis_liquid: str = "w/v"

    tol_solid: float = 0.05
    tol_liquid: float = 0.05

    enable_blocks: Dict[str, bool] = field(default_factory=lambda: {
